import img1 from "../Image/Marvel.jpg"
...
export default function ImageInserting(){
    return(
        ...
        <source src="public\Og_video.mp4"></source>
        </video>
